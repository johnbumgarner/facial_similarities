...
The algorithm was able to successfully predict that an image contain in the training data matched an image that was used in the training. The success rate was less accurate for images not used in the training data. 
